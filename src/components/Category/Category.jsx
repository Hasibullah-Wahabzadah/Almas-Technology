...
import Image2 from "../../assets/category/phone-3.png";
import Image3 from "../../assets/category/laptop-1-2.png";
      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end">
            ...
            <img src={Image1} alt="" className="w-[320px] absolute bottom-0 drop-shadow-[-8px_4px_6px_rgba(0,0,0,0.4)] hover:scale-105 duration-300" />
          </div>
          {/* second col */}
          <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end">
            ...
            <img
              src={Image2}
              alt=""
              className="w-[320px] absolute -right-8 lg:top-[10px] top-[9px] drop-shadow-[-8px_4px_6px_rgba(0,0,0,0.4)] hover:scale-105 duration-300"
            />
          </div>
          {/* third col */}
